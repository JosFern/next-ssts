...
function createData(first, last, email, position, Salary, password, companyName) {
    return { first, last, email, position, Salary, password, companyName };
}

const rows = [
    createData('Employer','main', 'employer1@gmail.com', 'ice cream', 20, '123123123', 'Lemondrop'),
    createData('main','Employer', 'employer2@gmail.com', 'ice cream', 20, '123123123', 'Workbean'),
];
            ...
            <Container>
                ...
                >
                    ...
                    <div>
                        ...
                        <Button onClick={() => setAddModal(true)} variant='contained'>+ Add Employer</Button>
